                           ...
                           <div class="row">
                              <div class="col">
                                 ...
                                 require_once("chat.php");
                                    ...
                                    $message = $chat->GetMessages($sender_name,$receiver_name,null);
                                    ?>                                
                                    <p class="group_post_font" style="margin-top: 0.5em;"><?php echo $message; ?></p>
                        ...
                        <div class="col">
                           <div class="row">
                              <div class="col">
                                    ...
                                    $message = $chat->SendMessage($sender_id,$receiver_id,$message,null);
                                    ?>
                        ...
                        <div class = "col">
                           <table>
                              <tr>
                                 ...
                                 <td>
                                    <input type="hidden" name="search_param" value="all" id="search_param">         
                                    <form class="form-inline my-2 my-lg-0" style="float: right" method = "POST" action = index.php>
                                       <textarea class="form-control" rows="1" id="post" name = "message" style="width:18em; height:2em; margin-top:0.2em"></textarea>
